...
Overall, the article gives citizens and professionals a clear view of a changing battlefield. It manages to give a simple representation of the changes in daily control files while keeping the difference between area gained and strategic importance visible. As for UX, desktop readers get more detail, and mobile readers can follow the charts and maps in a vertical sequence.
...
**The shape of the advances also tells us how the losses happened**. The 1,202 square kilometres were gained through several gradual, uneven movements.

Looking at the chart and maps together, we can see that November brought severe losses in area, while the consequences depended many factors such as distance from hotspots.

---

## Pipeline from raw information to the visualizations

Unfortunately we have **no description** of how the visualization was made. However, the claims the property of the graphics and we have a few details in the images' descriptions:

- For the barchart: "Monthly gains calculated based on Russian-controlled territory on the end of each month. Only includes land that has been assessed as under Russian control, and does not include latest Russian advances, which can lead to a delay."
- For the other one: "Only includes land that has been assessed as under Russian control, and does not include latest Russian advances."

### Sources and tools

- **Primary sources:** Daily control-of-terrain files from the [Institute for The Study of War](https://understandingwar.org/).
